...
const DEFAULT_CONTENT: YogaContent = {
  ...
  contactEmail: "contact@kanesunyoga.com",
  leads: [],
  studioName: "Kane Sun Yoga",
  hideHero: false,
  hideAbout: false,
  hideOfferings: false,
  hidePortfolio: false,
  ...
  aboutHeading: "Hi, I am Kane",
  aboutImageSubtitle: "Kane Sun • Founder of Jujuba",
  ...
  contactSubtitle: "Leave your details below, and we will get back to coordinate your custom session within 24 hours.",
  ...
  contactSuccessMessage: "Your request has been received and we will reach out soon.",
